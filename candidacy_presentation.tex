...
\setbeamercolor{palette primary}{bg=ONTech-dark-blue,fg=white}
\setbeamercolor{palette secondary}{bg=ONTech-light-blue,fg=white}
\setbeamercolor{palette tertiary}{bg=ONTech-orange,fg=white}
...
\setbeamercolor{section in toc}{fg=ONTech-dark-blue} % TOC sections
